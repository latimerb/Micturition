...
PARAMETER {
	interval	= 30.3 (ms) <1e-9,1e9>: time between spikes (msec)
	number	= 333 <0,1e9>	: number of spikes (independent of noise)
	start		= 10000(ms)	: start of first spike
