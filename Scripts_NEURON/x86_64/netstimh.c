...
#define erand erand_NetStimh
#define invl invl_NetStimh
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimh /storage/hpc/data/latimerb/Micturition_Parallel/Scripts_NEURON/x86_64/netstimh.mod\n");
