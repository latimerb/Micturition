...
#define erand erand_NetStimpud
#define invl invl_NetStimpud
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimpud /storage/hpc/data/latimerb/Micturition_Parallel/Scripts_NEURON/x86_64/netstimpud.mod\n");
