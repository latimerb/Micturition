...
#define erand erand_NetStimp
#define invl invl_NetStimp
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimp /storage/hpc/data/latimerb/Micturition_Parallel/Scripts_NEURON/x86_64/netstimp.mod\n");
