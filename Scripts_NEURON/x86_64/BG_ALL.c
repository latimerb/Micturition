...
#define tsyn _p[62]
#define fa _p[63]
#define Dr_nmda _p[64]
#define Dr_ampa _p[65]
#define Dcapoolcon _p[66]
#define _g _p[67]
#define _tsav _p[68]
...
#define eta eta_BG_ALL
#define omega omega_BG_ALL
#define sfunc sfunc_BG_ALL
#define unirand unirand_BG_ALL
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 BG_ALL /storage/hpc/data/latimerb/Micturition_Parallel/Scripts_NEURON/x86_64/BG_ALL.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 141 in file BG_ALL.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
